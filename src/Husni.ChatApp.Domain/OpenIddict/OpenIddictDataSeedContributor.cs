...
namespace Husni.ChatApp.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("ChatApp") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "ChatApp", DisplayName = "ChatApp API", Resources = { "ChatApp" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var blazorServerTieredClientId = configurationSection["ChatApp_BlazorServerTiered:ClientId"];
        if (!blazorServerTieredClientId.IsNullOrWhiteSpace())
        {
            var blazorServerTieredRootUrl = configurationSection["ChatApp_BlazorServerTiered:RootUrl"]!.EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["ChatApp_BlazorServerTiered:ClientSecret"] ?? "1q2w3e*",
